...
export class AvizierComponent implements OnInit {
  ...
  avizierSubscription (){
    this.avizierService.getAvizierPtLocatar(Number(this.apartamentId),this.anul, this.luna).subscribe({
      next:next=>{
    ...
    this.avizierService.getServiciiPtLocatar(this.apartamentId,this.anul, this.luna).subscribe({
      next:next=>{
        this.servicii = next;
      },
      error:error=>{
    ...
    this.avizierService.getCheltuieliPtLocatar(this.apartamentId,this.anul, this.luna).subscribe({
      next:next=>{
  ...
  setMonthAndYear(normalizedMonthAndYear: Moment, datepicker: MatDatepicker<Moment>) {
    ...
    window.location.replace('/locatar/apartament/' + this.apartamentId + '/avizier/an/' + this.anul + '/luna/' + this.luna);
    datepicker.close();
